...
const BLOG = {
  AUTHOR: 'wangzhaoo', // 作者
  BIO: '热爱生活的程序员', // 作者简介
  LINK: 'https://www.wangzhaoo.com', // 网站地址
  AVATAR: '/avatar.png', // 个人头像 默认取public目录下的avatar.png
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '69c557d6bf624466a1b57025c99ee1f7', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: '980540247@qq.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/wangzhaoo',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'wangzhaoo/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOHN5L8g', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHN5L8s4COt-1', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  // 无关紧要的配置
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Wangzhaoo BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
